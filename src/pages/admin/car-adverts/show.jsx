...
const CarAdvertFormData = ({ advert }) => {
  ...
  return (
    <Box>
      ...
      <Typography level="h3" align="center" sx={{ mt: 3 }}>
        Car details:
      </Typography>
      ...
      >
        <ShowItemCard
          title="Car"
          description={
            advert.car.model.manufacturer.name + " " + advert.car.model.name
          }
        />
        <ShowItemCard
          title="Manufacture year"
          description={advert.car.manufacture_year}
        />
        <ShowItemCard
          title="Vehicle identification number (VIN)"
          description={advert.car.vin}
        />
      </Box>
      <Box
        sx={{
      ...
      >
        <ShowItemCard
          ...
          description={advert.car.cubic_capacity}
        />
        <ShowItemCard title="Mileage" description={advert.car.mileage} />
        <ShowItemCard
          title="License plate"
          description={advert.car.license_plate}
        />
      </Box>
      <Box
        sx={{
      ...
      >
        ...
        <ShowItemCard
          title="Seat number"
          description={advert.car.seat_number}
        />
      </Box>
      <Box
        sx={{
      ...
      >
        <ShowItemCard
          title="Body type"
          description={advert.car.body_type.name}
        />
        <ShowItemCard title="Color" description={advert.car.color.name} />
        <ShowItemCard
          title="Fuel type"
          description={advert.car.fuel_type.name}
        />
      </Box>
      <Box
        sx={{
      ...
      >
        <ShowItemCard
          title="Gearbox"
          description={
            advert.car.gearbox.description + "(" + advert.car.gearbox.code + ")"
          }
        />
        {advert.car.status && (
          <ShowItemCard title="Status" description={advert.car.status.code} />
        )}
      </Box>
    </Box>
  );
